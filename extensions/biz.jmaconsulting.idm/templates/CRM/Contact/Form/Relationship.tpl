  ...
  {if $action eq 2 | $action eq 1} {* add and update actions *}
    ...
    <div class="crm-block crm-form-block crm-relationship-form-block">
            ...
            {else} {* action = add *}
             ...
             <tr class="crm-relationship-form-block-rel_contact">
               <td colspan="2">
                  ...
                  <script type="text/javascript">
                    ...
                    cj( function( ) {
                        ...
                        relationshipType.change( function() {
                            ...
                            cj('#relationship-refresh-saveemail').hide();
                            cj('#emails-save').parent().hide();
                            cj('#saveButtons').hide();
                            createRelation( );
                            changeCustomData( 'Relationship' );
                    ...
                    function afterCreateNew() {
                      ...
                      if ( relType && contactSelected ) {
                        ...
                        if (relType == '11_a_b' || relType == '11_b_a') {
                          cj('#relationship-refresh-saveemail').show( );
                          cj('#emails-save').parent().show();
                        }
                ...
                <span id="relationship-refresh-saveemail" class="crm-button crm-button-type-saveemail crm-button_qf_Relationship_refresh_saveemail" style="display:none">{$form._qf_Relationship_refresh_saveemail.html}</span> 
        ...
        {if $action EQ 1}
           ...
           <span class="crm-button crm-button-type-saveemails crm-button_qf_Relationship_refresh_saveemails" style="display:none;">{$form._qf_Relationship_refresh_saveemails.html}</span> 
            <span class="crm-button crm-button-type-cancel crm-button_qf_Relationship_cancel">{$form._qf_Relationship_cancel.html}</span>
            </div>
        {/if}
