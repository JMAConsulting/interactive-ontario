...
class CRM_Contact_Form_Relationship extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->addElement('submit', $this->getButtonName('refresh', 'saveemail'), 'Email & Quick Save', array('class' => 'form-submit', 'id' => 'email-quick-save'));
    $this->addElement('submit', $this->getButtonName('refresh', 'saveemails'), 'Email & Save Relationship', array('class' => 'form-submit', 'id' => 'emails-save'));
  ...
  public function postProcess() {
    ...
    if (CRM_Utils_Array::value('_qf_Relationship_refresh_save', $_POST) ||
      ...
      CRM_Utils_Array::value('_qf_Relationship_refresh_saveemail', $_POST) ||
      CRM_Utils_Array::value('_qf_Relationship_refresh_saveemails', $_POST)
    ) {
      $quickSave = TRUE;
    }
    ...
    // Custom functionailty to send emails
    if (CRM_Utils_Array::value('_qf_Relationship_refresh_saveemail', $_POST) ||
        CRM_Utils_Array::value('_qf_Relationship_refresh_saveemails', $_POST)) {
      $contactID = $params['contact_select_id'][1];
      list($displayName, $email) = CRM_Contact_BAO_Contact_Location::getEmailDetails($contactID);
      $sendTemplateParams = array(
        'groupName' => 'msg_tpl_workflow_claim',
        'valueName' => 'claim_email',
        'contactId' => $contactID,
        'tplParams' => array(
          'email' => $email,
          ),
